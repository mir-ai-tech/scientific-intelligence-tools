...
arxivdiff (https://arxivdiff.org/) — чтобы сравнивать версии статей и подсвечивать внесённые правки.
paperswithcode/methods (https://paperswithcode.com/methods) — хороший кодификатор модификаций отдельных блоков DL
https://github.com/monologg/nlp-arxiv-daily?tab=readme-ov-file#knowledge-graph - репа, которую обновляют боты каждые 12 часов
